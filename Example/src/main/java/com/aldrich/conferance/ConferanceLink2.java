...
public class ConferanceLink2 {
	...
	public static void main(String[] args) {
		...
		try {
				...
				document=getDocument("https://www.asugsvsummit.com/partners");
				...
				for (Element element : mainLinks) {
					...
					Elements title=document1.select("h1");
					//System.out.println(title.text());
					
					Elements url=document1.select("a[class='_00button-navy box s-margin w-button']");
