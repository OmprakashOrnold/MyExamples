...
public class Infrad {
	...
	public static void main(String[] args) throws InterruptedException  {
		...
		if(chromeDriver!=null)
		{
			...
			url.add("https://www.infrrd.ai/blog");
			...
			{ 	
				...
				WebElement el = companyPage.findElement(By.xpath("//a[@id='blog-listing-more']"));	
				el.click();

				
				scrollByVisibility(companyPage);
				}
	...
	public static void scrollByVisibility(WebDriver driver) {
		...
		WebElement el = driver.findElement(By.xpath("//a[@id='blog-listing-more']"));	
