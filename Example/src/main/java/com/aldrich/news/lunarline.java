...
public class lunarline {
	...
	public static void main(String[] args) {
		...
		try{
			...
			document=getDocument("https://lunarline.com/about-us/company-news/");
		
			Elements companyName1=document.select("a[class='w-btn us-btn-style_12']");
			for (Element element : companyName1) {
				...
				//.out.println(title.attr("content"));
