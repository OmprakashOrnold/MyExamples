...
public class LinkedInJobsExtraction {
	...
	public static void main(String[] args) {
		...
		File fullFileName = new File("C:\\Users\\oppeddamadthala\\Downloads\\jobs_info_v1\\jobs_info_v1\\1055.html" + 
				"");
		try {
			document = Jsoup.parse(fullFileName, "UTF-8");


			Elements elements = document.select("artdeco-carousel-content");
