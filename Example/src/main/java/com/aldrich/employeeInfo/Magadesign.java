package com.aldrich.employeeInfo;
...
public class Magadesign {
	...
	public static void main(String[] args) {
		...
		try{
			...
			document=getDocument("https://www.employeenavigator.com/About/Leadership");
            //https://www.magadesign.com/team
//			//.team-fullname
			//.team-title-cetered
		    //.team-headshot-main
			//.w-inline-block
			...
			//https://ainq.com/about-us/our-team/
			//et_pb_module_header
			//et_pb_member_position
			//et_pb_team_member_image et-waypoint et_pb_animation_off et-animated
			Elements companyName1=document.select("div[class='col-md-2 centered']");
			for (Element element : companyName1) {
				
			 System.out.println(element.getElementsByTag("img").attr("abs:src"));	
