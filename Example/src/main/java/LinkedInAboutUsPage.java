...
public class LinkedInAboutUsPage {
											...
											//confirmedLocations
												...
												String confirmedLocations=null;
														...
														if (isValid(innerObject1, "country")) {
															System.out.println(
																	"country: " + innerObject1.get("country").toString());
														}
														if (isValid(innerObject1, "geographicArea")) {
															System.out.println("geographicArea: "
																	+ innerObject1.get("geographicArea").toString());
														}
														if (isValid(innerObject1, "city")) {
															System.out.println(
																	"city: " + innerObject1.get("city").toString());
														}
														if (isValid(innerObject1, "postalCode")) {
															System.out.println("postalCode: "
																	+ innerObject1.get("postalCode").toString());
														}
														if (isValid(innerObject1, "line1")) {
															System.out.println(
																	"line1: " + innerObject1.get("line1").toString());
														}
														if (isValid(innerObject1, "line2")) {
															System.out.println(
																	"line2: " + innerObject1.get("line2").toString());
														}
