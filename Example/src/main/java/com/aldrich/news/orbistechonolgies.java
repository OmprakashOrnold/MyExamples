...
public class orbistechonolgies {
	...
	public static void main(String[] args) {
		...
		/*	document=getDocument("https://www.orbistechnologies.com/news/");
			...
			document=getDocument("https://www.orbistechnologies.com/blog/");
			Elements companyName1=document.select("a[class='btn elementor-button lastudio-more']");
			for (Element element : companyName1) {
