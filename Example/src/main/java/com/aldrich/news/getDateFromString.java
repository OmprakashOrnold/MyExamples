...
public class getDateFromString 
{
	public static void main(String[] args)
	{
		...
		for (String string : url) {			
			...
			String dateInString=getDateFromStringM(document.text());
			System.out.println(dateInString);
			Date date=convertAnyTypeDateToSingleFormat(dateInString);
	...
	public static String getDateFromStringM(String docText) {
		docText = docText.toLowerCase().replace("t.", "").toLowerCase().replace("th", "").replace("nd", "").replace("rd", "").replace(".", "");
		String date = "";
		String regex1 = "\\d{4,4}-(0?[1-9]|1[012])-(0?[1-9]|[12][0-9]|3[01])";
		String regex2 = "(0?[1-9]|[12][0-9]|3[01])\\/(0?[1-9]|1[012])\\/\\d{4,4}";
		String regex3 = "(0[1-9]|1[012])\\/(0[1-9]|[12][0-9]|3[01])\\/\\d{4,4}";
